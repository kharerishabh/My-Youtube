  ...
  return (
    <div className="grid grid-flow-col p-5 m-2 shadow-lg">
      <div className="flex col-span-1">
        <img className="h-8 cursor-pointer" alt="hambuger" src={HAM_BUR} onClick={toggleMenuHandler}/>
      ...
      <div className="col-span-10 px-14">
        ...
        <button className="border border-gray-500 rounded-r-full px-5 py-2 bg-gray-200">🔍</button>
      </div>
